    ...
    try {
        ...
        <div class="promo-card">
          ...
          <div class="promo-actions">
            <button class="btn btn-success btn-sm" data-vote-id="${p.id_promocao}" data-vote="1">👍 ${p.votos_positivos || 0}</button>
            <button class="btn btn-danger btn-sm" data-vote-id="${p.id_promocao}" data-vote="-1">👎 ${p.votos_negativos || 0}</button>
          </div>
        </div>
      `)
            .join("");
